  ...
  const QUESTIONS = [
    {
      ...
      choices: [
        'A pure substance that cannot be broken down into simpler substances through chemical processes',
        'Any substance made of two or more materials mixed together',
        'A substance that is always a gas at room temperature',
        'Any chemical formula with a subscript in it'
      ],
      correct: 0,
      explanation: 'An element is a unique substance that can’t be broken down further through chemical processes — the building materials of all matter.'
    },
    {
      id: 'q2', type: 'mc',
      ...
      choices: [
        ...
        'Any liquid mixture',
        'A substance with only one atom'
      ],
      correct: 1,
      explanation: 'A compound is two or more elements chemically combined in a fixed ratio, represented by a chemical formula.'
    },
    {
      id: 'q3', type: 'mc',
      prompt: 'Based on its formula alone, which of these is an element?',
      choices: ['H₂O', 'NaCl', 'Mn', 'CO₂'],
      correct: 2,
      explanation: 'Mn (manganese) is a single chemical symbol — no other elements combined with it — so it’s an element, not a compound.'
    },
    {
      id: 'q4', type: 'mc',
      prompt: 'How should a two-letter chemical symbol be written?',
      choices: [
      ...
      correct: 2,
      explanation: 'Chemical symbols always capitalize only the first letter — e.g. Zn, not ZN or zn.'
    },
    {
      id: 'q5', type: 'mc',
      prompt: 'What does the label (aq) mean on a chemical formula?',
      choices: [
        'The substance is a gas',
        'The substance is dissolved in water',
        'The substance is radioactive',
        'The substance is a solid crystal'
      ],
      correct: 1,
    ...
    {
      id: 'q6', type: 'mc',
      prompt: 'A bottle is labeled MgCl₂(aq). What should you expect to find inside?',
      choices: [
        'A clear, colorless gas',
        'Dry crystals or powder, not dissolved in anything',
        'The compound dissolved in water — a liquid solution',
        'A solid block of magnesium metal'
      ],
      correct: 2,
      explanation: 'The (aq) tells you it’s aqueous — dissolved in water — so you’d see a liquid solution, not dry crystals.'
    },
    {
      id: 'q7', type: 'mc',
      prompt: 'What is the Law of Conservation of Mass?',
      choices: [
        'Mass increases every time a chemical reaction happens',
        'Mass cannot be created or destroyed in a chemical reaction',
        'Mass and volume are always equal',
        'Only gases have mass during a reaction'
      ],
      correct: 1,
      explanation: 'The Law of Conservation of Mass states that matter (and its mass) cannot be created or destroyed in a chemical reaction — only rearranged.'
    },
    {
      id: 'q8', type: 'mc',
      prompt: 'In the copper cycle lab, copper changed color and form several times, but its mass at the end was about the same as at the start. What does this show?',
      choices: [
        'Copper was destroyed and a new element was created',
        'Copper can combine and recombine into different compounds without being created or destroyed',
        'The scale was broken',
        'Copper turned into gold'
      ],
      correct: 1,
      explanation: 'Elements combine and recombine during chemical changes, but they are not created or destroyed — evidence for the law of conservation of mass.'
    },
    {
      id: 'q9', type: 'mc',
      prompt: 'KI(aq) is added to Pb(NO₃)₂(aq). The reaction produces KNO₃(aq) and a new solid. Which is most likely the solid product?',
      choices: [
        'KI(aq), since it was one of the starting substances',
        'Pb(NO₃)₂(aq), since it was one of the starting substances',
        'A new compound formed from the reactants, appearing as a solid — like PbI₂(s)',
        'KNO₃(aq), since a reaction happened'
      ],
      correct: 2,
      explanation: 'A solid forming out of two dissolved (aq) solutions means a brand-new, insoluble compound formed — here, PbI₂(s). The reactants themselves are listed as (aq), not (s).'
    },
    {
      id: 'q10', type: 'mc',
      prompt: 'Mendeleev organized his periodic table based on which two properties?',
      choices: [
        'Color and smell',
        'Reactivity and atomic mass',
        'Melting point and price',
        'Alphabetical order'
      ],
      correct: 1,
      explanation: 'Mendeleev arranged elements by reactivity and atomic mass — an arrangement that even predicted undiscovered elements.'
    },
    {
      id: 'q11', type: 'mc',
      prompt: 'What is atomic mass?',
      choices: [
      ...
      correct: 1,
      explanation: 'Atomic mass is the mass of a single atom (or isotope) of an element, usually shown as a decimal on the periodic table.'
    },
    {
      id: 'q12', type: 'mc',
      ...
      choices: [
        ...
        'The mass of the whole atom',
        'The number of compounds an element can form',
        'The group number on the periodic table'
      ],
      correct: 0,
      explanation: 'Atomic number equals the number of protons in an atom’s nucleus — it’s what an element’s identity is based on.'
    },
    {
      id: 'q13', type: 'mc',
      prompt: 'A vertical column on the periodic table is called a:',
      choices: ['Period', 'Group', 'Phase', 'Family reunion'],
      correct: 1,
      explanation: 'A vertical column is a group — elements in the same group share similar properties.'
    },
    {
      id: 'q14', type: 'mc',
      prompt: 'A horizontal row on the periodic table is called a:',
      choices: ['Group', 'Period', 'Series', 'Column'],
      correct: 1,
      explanation: 'A horizontal row is a period.'
    },
    {
      id: 'q15', type: 'mc',
      prompt: 'The elements in Group 7A are called the:',
      choices: ['Alkali metals', 'Alkaline earth metals', 'Halogens', 'Noble gases'],
      correct: 2,
      explanation: 'Group 7A elements are the halogens.'
    },
    {
      id: 'q16', type: 'mc',
      prompt: 'The elements in Group 8A are called the noble gases. Why "noble"?',
      choices: [
        'They are the heaviest elements',
        'They are not reactive',
        'They were discovered by royalty',
        'They are only found in outer space'
      ],
      correct: 1,
      explanation: 'They’re called "noble" gases because they are not reactive — they don’t readily combine with other elements.'
    },
    {
      id: 'q17', type: 'mc',
      prompt: 'Where are metalloids found on the periodic table?',
      choices: [
        'Scattered randomly throughout',
        'Only in the two bottom rows (lanthanides and actinides)',
        'Along the stair-step line, between the metals and nonmetals',
        'Only in Group 1A'
      ],
      correct: 2,
      explanation: 'Metalloids sit along the stair-step line, with properties between metals and nonmetals.'
    }
  ];
...
`;
  ...
  // ---- Static lesson content (sections 0-4, ungraded / session-only) ----
  ...
  const STATIC_SECTIONS = [
    ...
    },
    {
      ...
      bodyHtml: `
        ...
        ${practiceProblem('e1', 'Is <span class="formula-chip">Mn</span> an element or a compound?', 'basic', 'Count the different element symbols in the formula.', 'Element — Mn (manganese) is a single symbol, no other elements combined with it.')}
        ${practiceProblem('e2', 'Is <span class="formula-chip">H₂</span> an element or a compound?', 'medium', 'The subscript tells you how many atoms — but how many <em>different</em> elements are shown?', 'Element — H₂ is two atoms of the same element (hydrogen gas), not a combination of different elements.')}
        ${practiceProblem('e3', 'Is <span class="formula-chip">ZnSO₄</span> an element or a compound?', 'medium', 'How many different element symbols appear in this formula?', 'Compound — it combines zinc (Zn), sulfur (S), and oxygen (O): three different elements in a fixed ratio.')}
        ${practiceProblem('e4', 'Is <span class="formula-chip">Na₃PO₄</span> an element or a compound?', 'challenge', 'Same test as always — how many different elements does it combine?', 'Compound — it combines sodium (Na), phosphorus (P), and oxygen (O).')}`
    },
    {
      title: 'Phases & Aqueous Solutions',
      time: '6 min',
      bodyHtml: `
        ...
        ${practiceProblem('a1', 'A bottle is labeled <span class="formula-chip">Cu₂SO₄(aq)</span>. What should you expect to see inside?', 'basic', 'What does (aq) tell you about where the compound is?', 'A liquid solution — the compound is dissolved in water, so you\'d see a (blue) liquid, not dry crystals.')}
        ${practiceProblem('a2', 'What is the correct formula + phase label for ice?', 'medium', 'Water is H₂O — what phase is ice?', 'H₂O(s) — ice is solid water.')}
        ${practiceProblem('a3', 'What do all substances labeled (aq) have in common?', 'medium', 'Think about what the letters a-q stand for.', 'They are all dissolved in water (aqueous solutions).')}`
    },
    {
      title: 'Chemical Change & Conservation of Mass',
      time: '8 min',
      bodyHtml: `
    ...
    },
    {
      ...
      bodyHtml: `
        ...
        ${practiceProblem('r1', 'Is silicon (Si) a metal, nonmetal, or metalloid?', 'basic', 'Silicon sits right along the stair-step line.', 'Metalloid — silicon is one of the classic metalloids, right on the stair-step line.')}
        ${practiceProblem('r2', 'In what phase would you expect to find bromine (Br) at room temperature?', 'medium', 'Bromine is one of the few elements that is neither a solid nor a gas at room temperature.', 'Liquid — bromine is one of only two elements that are liquid at room temperature (along with mercury).')}
        ${practiceProblem('r3', 'Which family are the Group 1A elements, and are they generally very reactive or not very reactive?', 'medium', 'This is the leftmost column of the main group elements.', 'Alkali metals — they are highly reactive, especially with water.')}
        ${practiceProblem('r4', 'Would you expect argon (Ar) to react easily with other elements? Why or why not?', 'challenge', 'What group is argon in?', 'No — argon is a noble gas (Group 8A), and noble gases are "noble" specifically because they are not reactive.')}`
    }
  ];
  ...
  function render(host, ctx) {
    ...
    host.innerHTML = `
      <div class="el-lesson">
        <div class="el-header">
          <div class="el-header-label">Chapter 2 · Basic Building Materials</div>
          <h1>${escapeHtml(ctx.activity.title)}</h1>
          <div class="el-header-meta">Self-Paced Review · ~40 Minutes · Good prep for Quiz A/B</div>
        </div>
        <div class="el-progress-wrap">
          <span class="el-progress-label">Progress</span>
          <div class="el-progress-track"><div class="el-progress-fill" id="el-progress-fill"></div></div>
          <span class="el-progress-count" id="el-progress-count">0 / ${SECTION_COUNT} sections</span>
        </div>
        <main>
          ${sectionsHtml}
    ...
    function updateProgress() {
      ...
      root.querySelector('#el-progress-count').textContent = `${done} / ${SECTION_COUNT} sections`;
    }
  ...
  function renderQuizQuestion(mount, ctx, answersSoFar, index) {
    ...
    mount.innerHTML = `
      ...
      <button type="button" class="el-next-btn" id="el-next-btn" style="display:none;">Next Question</button>
    `;
    ...
    answerArea.innerHTML = q.choices.map((choice, i) => `
      <button type="button" class="el-choice" data-choice="${i}">${escapeHtml(choice)}</button>
    `).join('');
  ...
  function renderQuizSummary(mount, ctx) {
    ...
    mount.innerHTML = `
      <div class="el-summary">
        ...
        <button type="button" class="el-retake-btn" id="el-retake-btn">Retake Quiz</button>
      </div>
    `;
