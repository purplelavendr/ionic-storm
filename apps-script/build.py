...
JS_FILES = [
    ...
    ('AtomicModelsJs.html', 'js/activities/atomic-models.js'),
    ('ParticlesReviewJs.html', 'js/activities/particles-review.js'),
...
<body>
  ...
  <?!= include('AtomicModelsJs'); ?>
  <?!= include('ParticlesReviewJs'); ?>
